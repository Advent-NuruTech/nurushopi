        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <a href="#" className="w-9 h-9 rounded-full bg-slate-100 dark:bg-gray-800 flex items-center justify-center hover:bg-green-100 dark:hover:bg-green-900/30 hover:scale-110 transition-all duration-200" aria-label="Facebook">
                <Facebook className="w-4 h-4 text-slate-600 dark:text-gray-400" />
              </a>
              <a href="#" className="w-9 h-9 rounded-full bg-slate-100 dark:bg-gray-800 flex items-center justify-center hover:bg-green-100 dark:hover:bg-green-900/30 hover:scale-110 transition-all duration-200" aria-label="Instagram">
                <Instagram className="w-4 h-4 text-slate-600 dark:text-gray-400" />
              </a>
              <a href="#" className="w-9 h-9 rounded-full bg-slate-100 dark:bg-gray-800 flex items-center justify-center hover:bg-green-100 dark:hover:bg-green-900/30 hover:scale-110 transition-all duration-200" aria-label="Twitter">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-sm text-slate-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-500 transition-colors duration-200 flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-slate-600 dark:text-gray-400">
                ...
                <a href="tel:+254105178685" className="hover:text-green-600 dark:hover:text-green-500 transition-colors">
                  +254 105 178 685
                </a>
              </li>
              <li className="flex items-start gap-3 text-sm text-slate-600 dark:text-gray-400">
                <Mail className="w-4 h-4 mt-0.5 text-green-600 flex-shrink-0" />
                <a href="https://wa.me/254105178685" className="hover:text-green-600 dark:hover:text-green-500 transition-colors">
                  WhatsApp Chat
                </a>
              </li>
              <li className="flex items-start gap-3 text-sm text-slate-600 dark:text-gray-400">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-gray-800">
          ...
          <div className="mt-6 text-center">
            <a
              ...
              target="_blank"
              className="text-sm font-bold bg-gradient-to-r from-blue-700 via-green-600 to-emerald-500 bg-clip-text text-transparent hover:scale-105 transition-transform duration-200 inline-block"
            >
              Powered by Advent NuruTech
            </a>
          </div>
