...
function HeaderBar({
  ...
  return (
    <div className={`w-full ${className}`}>
      <div className="w-full flex items-center text-white px-2 sm:px-6 py-3 rounded-xl shadow-sm text-sm sm:text-base font-bold tracking-wide bg-[#009933]">
        ...
        {shouldShowViewAll && (
          <div className="flex-1 text-right">
            <Link
              href={href as Route}
              className="underline-offset-4 hover:underline font-semibold whitespace-nowrap hover:text-[#00C83A] transition-colors duration-200"
            >
              {viewText}
            </Link>
          </div>
